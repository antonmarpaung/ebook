    ...
    <ul>
        ...
        <li>
            ...
            <ul class="feat-show">
                ...
                <li><a href="DaftarAdmin.php"><b><font color="#808080">Daftar Admin </font></b> </a></li>
            </ul>
        </li>
        <li>
        ...
        <li><a href="#"><i class="fa-sharp fa-solid fa-user-secret"></i> Create New Admin</a></li>
...
<div class="tambah"><a href="tambahbuku.php"><button type="button" class="btn btn-success"><span><i class="fa-solid fa-user-plus"></i></span> Tambah</button></a></div>
    </div>
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<tr>";
     echo "<th><center>ID Admin</th></center>";
  ...
  <tbody>
    ...
    while($row = mysqli_fetch_array($result)) {
        echo "<tr>";
         echo "<td><center> Admin-" . $row['id'] . "</center></td>";
        echo "<td><center>" . $row['username'] . "</center></td>";
        echo "<td><center>" . $row['password'] . "</center></td>";
        "</tr>";
        ?>
       <td> <center><a href="editbuku.php?id=<?= $row["id"]; ?>" ><input type="button" class="btn btn-info" value="Edit"></input> </a>| |   
            <a href="deletebuku.php?id=<?= $row["id"]; ?>"  onclick="return confirm('Apakah Anda yakin ingin menghapus <?php echo $row['username'] ?>?')"><span style="color: #890519;">
