...
<form action="jumlah_cetak.php" method="post">
 <table class="table" style="color : white; font-size: 15px;">
 	<tr>
 		<td>Nama buku</td>
 		<td>:</td>
 		<td><?php echo "$namabuku" ?></td>
        <input type="hidden" name="namabuk" value="<?php echo $namabuku ?>">
 	</tr>
 	<tr>
 		<td>Genre</td>
 		<td>:</td>
    ...
    <tr>
        ...
        <input type="hidden" name="totbayar" value="<?php echo $totbay ?>">        
    </tr>
   

 </table>
<div class="col-md-8 col-md-offset-1" style="font-family: zen dots; color: white;">
  <input target="_blank" style="width: 100px; height:30px; border-radius: 10px;" type="submit" value="BAYAR" class="btn btn-danger pull-right" ><br/><br><br>
    </div>
