...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous" />
  ...
  <body>
    ...
    <div class="card" data-aos="fade-right">
        <b><p class="login">Admin</p></b>
       
 
        <form>
            <label>Username</label>
            <input type="text" name="username1" class="form_login" placeholder="Username" autocomplete="off" oninvalid="this.setCustomValidity('Mohon Isi Sesuai Dengan Ketentuan')" oninput="this.setCustomValidity('')" required >
