...
<header><div class="gambar1" style="width:48px;background-color:#ffffff;border-radius: 10px;height: 60px;"><a href="#"><img class="animate__slideInDown" src="img/pola.png" style="width:35px; margin-top: 10px; margin-left: 6.5px;"></div>
	...
	<a href="#"><button class="btn-1"><img src="img/keluar.png" style="width:30px"> Login </button></a>
	</header>
  ...
  <div class="card-2">
   ...
   <div class="card-1">	
	...
	<div class="form-group-4">
		<h4>Nama Pembeli</h4>
		<input type="text" class="form-control" name="nampel" placeholder="Masukan Nama Lengkap">
	</div>
	<div class="form-group-4">	
		<h4>Alamat</h4>
	...
	<div class="form-group-5">	
		...
		<select class="form-select" aria-label="Default select example" name="jenisbar">
	...
	<div class="form-group-6">		
		...
		<input type="number" class="form-control" name="jumpel" placeholder="Jika Membeli Selusin/Lebih Akan Mendapatkan Diskon" >
	</div>
		<div class="form-group-5">
